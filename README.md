...
that adds **Bitbucket Data Center** as a third service. The 37 Bitbucket tools
cover projects, repositories, branches and tags (including creating them and
deleting a branch), commits and their build statuses, source browsing, ref
comparison, the caller's identity, and pull requests from creation through
review (comments, tasks, approval, merge readiness) to merge, decline, or
reopen. Install from this repository with `uvx --from git+...`
...
**135 tools total** — See the [Tools Reference](docs/tools-reference.mdx) for the complete list.
