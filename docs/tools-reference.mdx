...
description: "Overview of all 120 MCP tools for Jira, Confluence, and Bitbucket — organized by category with quick links"
---

MCP Atlassian provides **120 tools** for interacting with Jira, Confluence, and Bitbucket Data Center. Tools are organized by category below.
