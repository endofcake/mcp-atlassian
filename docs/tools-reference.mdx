...
**Bitbucket Data Center Toolsets (3):** read-only, all off by default.

| Toolset | Core | Tools |
|---------|:----:|-------|
| `bitbucket_projects` | No | `bitbucket_list_projects` |
| `bitbucket_repositories` | No | `bitbucket_list_repositories` |
| `bitbucket_pull_requests` | No | `bitbucket_list_pull_requests`, `bitbucket_get_pull_request`, `bitbucket_get_pull_request_diff`, `bitbucket_get_pull_request_activities`, `bitbucket_get_pull_request_comments` |
