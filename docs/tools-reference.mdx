...
description: "Overview of all 122 MCP tools for Jira, Confluence, and Bitbucket — organized by category with quick links"
---

MCP Atlassian provides **122 tools** for interacting with Jira, Confluence, and Bitbucket Data Center. Tools are organized by category below.
