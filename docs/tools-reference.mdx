...
description: "Overview of all 134 MCP tools for Jira, Confluence, and Bitbucket — organized by category with quick links"
---

MCP Atlassian provides **134 tools** for interacting with Jira, Confluence, and Bitbucket Data Center. Tools are organized by category below.
...
Bitbucket tools work with Bitbucket Data Center.

<CardGroup cols={2}>
  <Card title="Projects" icon="folder-tree" href="/docs/tools/bitbucket-projects">
    List Bitbucket Data Center projects
  </Card>
  <Card title="Repositories" icon="code-branch" href="/docs/tools/bitbucket-repositories">
    Repositories, branches, tags, commits, source browsing
  </Card>
  <Card title="Pull Requests" icon="code-pull-request" href="/docs/tools/bitbucket-pull-requests">
    Pull requests, diffs, comments, and reviews
  </Card>
  <Card title="Users" icon="user" href="/docs/tools/bitbucket-users">
    Identify the user the server is acting as
  </Card>
</CardGroup>
...
| Toolset | Core | Tools |
|---------|:----:|-------|
| `bitbucket_projects` | No | `bitbucket_list_projects` |
| `bitbucket_repositories` | No | `bitbucket_list_repositories`, `bitbucket_list_branches`, `bitbucket_list_tags`, `bitbucket_get_tag`, `bitbucket_get_default_branch`, `bitbucket_create_branch`, `bitbucket_delete_branch`, `bitbucket_create_tag`, `bitbucket_list_commits`, `bitbucket_get_commit`, `bitbucket_get_commit_build_status`, `bitbucket_browse_path`, `bitbucket_compare_changes`, `bitbucket_compare_commits`, `bitbucket_compare_diff` |
| `bitbucket_pull_requests` | No | `bitbucket_list_pull_requests`, `bitbucket_list_user_pull_requests`, `bitbucket_get_pull_request`, `bitbucket_get_pull_request_merge_status`, `bitbucket_get_pull_request_commits`, `bitbucket_get_pull_request_changes`, `bitbucket_get_pull_request_diff`, `bitbucket_get_pull_request_activities`, `bitbucket_get_pull_request_comments`, `bitbucket_create_pull_request`, `bitbucket_add_pull_request_comment`, `bitbucket_set_pull_request_review_status`, `bitbucket_edit_pull_request_comment`, `bitbucket_resolve_pull_request_comment`, `bitbucket_resolve_pull_request_task`, `bitbucket_delete_pull_request_comment`, `bitbucket_merge_pull_request`, `bitbucket_decline_pull_request`, `bitbucket_reopen_pull_request` |
| `bitbucket_users` | No | `bitbucket_get_current_user` |
...
# Command line
uvx --from git+https://github.com/endofcake/mcp-atlassian mcp-atlassian --enabled-tools "confluence_search,jira_get_issue,jira_search"
```
