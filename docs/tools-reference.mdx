...
toolset includes a write tool (`bitbucket_add_comment`, gated by `READ_ONLY_MODE`).

| Toolset | Core | Tools |
|---------|:----:|-------|
| `bitbucket_projects` | No | `bitbucket_list_projects` |
| `bitbucket_repositories` | No | `bitbucket_list_repositories` |
| `bitbucket_pull_requests` | No | `bitbucket_list_pull_requests`, `bitbucket_get_pull_request`, `bitbucket_get_pull_request_diff`, `bitbucket_get_pull_request_activities`, `bitbucket_get_pull_request_comments`, `bitbucket_add_comment` |
