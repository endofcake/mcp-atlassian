...
description: "Overview of all 127 MCP tools for Jira, Confluence, and Bitbucket — organized by category with quick links"
---

MCP Atlassian provides **127 tools** for interacting with Jira, Confluence, and Bitbucket Data Center. Tools are organized by category below.
