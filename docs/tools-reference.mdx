...
description: "Overview of all 119 MCP tools for Jira, Confluence, and Bitbucket — organized by category with quick links"
---

MCP Atlassian provides **119 tools** for interacting with Jira, Confluence, and Bitbucket Data Center. Tools are organized by category below.
...
| `bitbucket_repositories` | No | `bitbucket_list_repositories`, `bitbucket_list_branches`, `bitbucket_list_tags`, `bitbucket_get_tag`, `bitbucket_get_default_branch`, `bitbucket_list_commits`, `bitbucket_get_commit`, `bitbucket_browse_path` |
