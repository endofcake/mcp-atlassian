...
| `  ├─ bitbucket/` | Bitbucket Data Center client + 8 mixins (projects, repos, PRs, …) |
...
- **Mixin composition**: `JiraFetcher` composes 21 mixins, `ConfluenceFetcher` composes 8, `BitbucketFetcher` composes 8. Client inheritance is transitive through mixins.
