...
| `  ├─ bitbucket/` | Bitbucket Data Center client + 9 mixins (projects, repos, PRs, builds, compare, …) |
...
- **Mixin composition**: `JiraFetcher` composes 21 mixins, `ConfluenceFetcher` composes 8, `BitbucketFetcher` composes 9. Client inheritance is transitive through mixins.
